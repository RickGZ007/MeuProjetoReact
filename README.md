Aqui está o conteúdo completo e estruturado exatamente no estilo que você pediu, unindo todas as partes (Local, Docker, Ciclo de Atualização e Comandos) em um único bloco pronto para copiar:
